...
<body>
 <div id="wrap">
   ...
   <%--메인 본문 --%>
   <article id="main_cont"> <%-- article태그는 html5에서 추가된 것으로 본문 내용을 구성할 때 주로 사용 --%>
     <div id="solution">
      <div id="hosting">
     ...
     <div id="news_notice">
       <h3 class="brown">News &amp; Notice</h3> <%-- &amp;은 특수문자로 &로 표시 --%>
       <table>
         <tr>
   ...
   <%--하단영역 --%>
   <footer> <%-- footer태그도 html5에서 추가된 것으로 하단 영역을 지정할 때 사용한다. --%>
    <hr>
    <div id="copy">
